...
from opendbc.car.canabstractcar.values import CAR as CANABSTRACTCAR
...
Platform = BODY | CANABSTRACTCAR | CHRYSLER | FORD | GM | HONDA | HYUNDAI | MAZDA | MOCK | NISSAN | PSA | RIVIAN | SUBARU | TESLA | TOYOTA | VOLKSWAGEN
